...
function onEdit(td) {
    variables = td.parentElement.parentElement;
    document.getElementById("title").value = variables.cells[0].innerHTML;
    document.getElementById("author").value = variables.cells[1].innerHTML;
    document.getElementById("price").value = variables.cells[2].innerHTML;
    document.getElementById("date").value = variables.cells[3].innerHTML;
    document.getElementById("language").value = variables.cells[4].innerHTML;
}
